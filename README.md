...
- 已完成总体架构与技术选型
- 已完成第一版实现骨架说明与基础工程搭建
- 已落地 `project`、`asset`、`collection`、`reuse`、`draft create/show` 的最小 CLI/服务/模型闭环
- 已补充任务 1、任务 2、任务 4 的端到端验收场景，以及任务 3、任务 4 的单元测试与集成测试
- 任务 5、任务 6 仍处于待实现状态
...
1. 实现任务 5 的 `draft update` 最小闭环
2. 在任务 5 落地后补齐对应单测、集成测试和验收场景
3. 继续推进 `export`、`archive`，保持每个任务单独闭环
